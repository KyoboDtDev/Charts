...
open class BarChartRenderer: BarLineScatterCandleBubbleRenderer
{
    ...
    @objc open func drawDataSet(context: CGContext, dataSet: BarChartDataSetProtocol, index: Int)
    {
        ...
        {
            drawGradientBars(context: context, dataSet: dataSet as! BarChartDataSet, dateSetIndex: index, buffer: buffer, matrix: valueToPixelMatrix)
        }
        else
        {
            drawNormalBars(context: context, dataSet: dataSet as! BarChartDataSet, dateSetIndex: index, buffer: buffer)
        }
    }

    private func drawGradientBars(context: CGContext, dataSet: BarChartDataSet, dateSetIndex index: Int, buffer: BarChartRenderer.Buffer, matrix: CGAffineTransform)
    {
    ...
    private func drawNormalBars(context: CGContext, dataSet: BarChartDataSet, dateSetIndex index: Int, buffer: BarChartRenderer.Buffer)
    {
        let drawBorder = dataSet.barBorderWidth > 0
